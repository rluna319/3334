...
/*
	...
	This is phase 3 of my SIC (Simplified Instructional Computer) simulator.
...
table and an intermediate file. Phase 3 now implements Pass 2 of the 2 pass
assembler. Pass 2 will create the object file and listing file from the newy 
generated intermediate file and symbol table. The following are the names of 
...
Comment 2: The other SIC commands for Phase 4 are also availabale but they have a
few bugs in this version. These are fixed in Phase 4. 
       					end
*/
